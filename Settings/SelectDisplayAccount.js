                ...
                <View style={styles.selectionContainer}>
                    ...
                    <View style={styles.runbox}>
                        <View style={styles.box}>
                            ...
                            <Image style={styles.img} source={require('../assets/running.png')}/>
                    ...
                    <View style={styles.petbox}>
                        <View style={styles.box}>
                            <View style={styles.line}></View>
                            <Image style={styles.img} source={require('../assets/animal-shelter.png')}/>
                            <TouchableOpacity   onPress={() => navigation.navigate('AccountPet')}>
                                <View >
